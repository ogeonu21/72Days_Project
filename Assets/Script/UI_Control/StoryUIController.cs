...
public class StoryUIController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        storyManager.OnStoryNodeChanged += UpdateStoryUI;
    }

    public void UpdateStoryUI(StoryNode node)
    {
        TypewriterEffect.StartTyping(this, dialogueText, node.dialogueText, 0.05f);
        ...
        if (node.choices != null && node.choices.Count > 0)
        {
            ...
            {
                if (node.choices[i].choiceText != null) {
                    int index = i;
